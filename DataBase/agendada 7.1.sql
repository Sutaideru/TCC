...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 21-Out-2025 às 10:52
...
CREATE TABLE IF NOT EXISTS `cursos` (
  ...
  `turnos_curso` enum('M','T','N','MT','MN','TN','MTN') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`IDcurso`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `professores` (
  ...
  `turnos_professor` enum('M','T','N','MT','MN','TN','MTN') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `relacoes` (
  ...
  `turnos` enum('M','T','N','MT','MN','TN','MTN') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
('admin', '$2b$10$iJsyu9LBrezZV52HMAP3gOsrJyopkUp0f1zrAyYZiIEx84WWNE.vK');

...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 22-Set-2025 às 10:24
...
CREATE TABLE IF NOT EXISTS `competencias` (
  ...
  `professor_competencia` int NOT NULL,
  `cursos_competencia` int NOT NULL,
  PRIMARY KEY (`IDcompetencia`),
  KEY `profess` (`professor_competencia`),
...
CREATE TABLE IF NOT EXISTS `curso` (
  ...
  `professor_curso` int NOT NULL,
  `competencia_curso` int NOT NULL,
  PRIMARY KEY (`IDcurso`),
  KEY `profes` (`professor_curso`),
  KEY `compet` (`competencia_curso`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
ALTER TABLE `competencias`
  ...
  ADD CONSTRAINT `profess` FOREIGN KEY (`professor_competencia`) REFERENCES `professores` (`matricula`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `curso`
--
ALTER TABLE `curso`
  ADD CONSTRAINT `compet` FOREIGN KEY (`competencia_curso`) REFERENCES `competencias` (`IDcompetencia`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `profes` FOREIGN KEY (`professor_curso`) REFERENCES `professores` (`matricula`) ON DELETE CASCADE ON UPDATE CASCADE;

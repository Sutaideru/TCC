...
<ul class="nav" style="background-color: #005caa;">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="curso_add.php" style="color:white;">Adicionar Curso</a>
  </li>
  <li class="nav-item">
...
<form action="processar_curso.php" method="POST">
  ...
  <button type="submit" class="btn btn-primary" style="margin-left: 35%; margin-top: 20px;">Cadastrar Curso</button>
</form>
</body>
</html>
